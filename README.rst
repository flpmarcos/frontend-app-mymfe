...
replace all instances of ``frontend-app-mymfe`` with the name of
...
1. Clone your new repo:
  ...
  ``git clone https://github.com/openedx/frontend-app-mymfe.git``
...
3. Install npm dependencies:
  ...
  ``cd frontend-app-mymfe && npm install``
...
This section concerns development of ``frontend-app-mymfe`` itself,
...
.. _Feature-based Application Organization ADR: https://github.com/openedx/frontend-app-mymfe/blob/master/docs/decisions/0002-feature-based-application-organization.rst
...
https://github.com/openedx/frontend-app-mymfe/issues
...
.. _Backstage: https://open-edx-backstage.herokuapp.com/catalog/default/component/frontend-app-mymfe
...
.. |license-badge| image:: https://img.shields.io/github/license/openedx/frontend-app-mymfe.svg
    :target: https://github.com/openedx/frontend-app-mymfe/blob/main/LICENSE
    :alt: License

.. |status-badge| image:: https://img.shields.io/badge/Status-Maintained-brightgreen

.. |ci-badge| image:: https://github.com/openedx/frontend-app-mymfe/actions/workflows/ci.yml/badge.svg
    :target: https://github.com/openedx/frontend-app-mymfe/actions/workflows/ci.yml
    :alt: Continuous Integration

.. |codecov-badge| image:: https://codecov.io/github/openedx/frontend-app-mymfe/coverage.svg?branch=main
    :target: https://codecov.io/github/openedx/frontend-app-mymfe?branch=main
    :alt: Codecov
